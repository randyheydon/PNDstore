I'll write more here once it's finished, I promise.

The contents of test/testfiles come from a variety of sources:
* "apps" is from libpnd, by skeezix, and is licensed under the LGPL.  See http://git.openpandora.org/cgi-bin/gitweb.cgi?p=pandora-libraries.git
